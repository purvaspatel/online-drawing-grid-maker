...
export function SiteFooter() {
    return (
        <footer className="border-t border-gray-200 dark:border-gray-800 bg-white ">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link href="/blog/grid-drawing-technique" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm">
                                    Grid Method Guide
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link href="/blog/best-online-resources-to-learn-drawing" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm">
                                    Recommended Tools
                                </Link>
                            </li>
                        </ul>
                ...
                <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-500 dark:text-gray-400 text-sm mb-4 md:mb-0">
                        © {new Date().getFullYear()} GridDraw. All rights reserved.
                    </p>
                    <div className="flex space-x-6">
                        <Link href="https://x.com/purvaspatel" className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
                            <span className="sr-only">Twitter</span>
                            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                            </svg>
                        </Link>
                        <Link href="https://github.com/purvaspatel" className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
                        ...
                        <Link href="https://instagram.com/purvvvva" className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
